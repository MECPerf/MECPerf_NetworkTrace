...
GNUTERM = "wxt"
## Last datafile plotted: "< cat ../data/migrations.dat | tr -d + | tr -d -- -"
plot '< cat ../data/migrations.dat | tr -d + | tr -d -- -' u ($1/100):($2/1000):($3/1000) w ye notitle, '' u ($1/100):($2/1000) w l lt 1 notitle
#    EOF
